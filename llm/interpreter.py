...
7. `semantic_state.affordances`는 반드시 아래 허용 태그 중에서만 선택하라. 목록에 없는 affordance 문자열은 절대 만들지 마라.

허용 affordance 태그:
- Observe: 단순히 관찰할 수 있는 대상
- Grasp: 손으로 잡을 수 있는 대상
- Drink: 마실 수 있는 대상
- Sit: 앉을 수 있는 대상
- Open: 열 수 있는 대상
- Press: 버튼처럼 누를 수 있는 대상
- Read: 글자나 화면처럼 읽을 수 있는 대상
- Write: 필기하거나 입력할 수 있는 대상
"""
